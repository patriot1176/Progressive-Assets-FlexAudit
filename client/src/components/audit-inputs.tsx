...
import { Info, RotateCcw, Shield, Target, Zap } from "lucide-react";
...
function NumberField({ label, value, onChange, min = 0, suffix, prefix, step, testId, tooltip }: {
  label: string;
  value: number;
...
function OptionalNumberField({ label, value, onChange, suffix, prefix, step, testId }: {
  label: string;
  value: number | null;
